...
const projects = [
  ...
  ["04", "EduScan", "Gestion de scolarité", "Application mobile académique pour vérifier les paiements étudiants par scan de QR code et gérer les données via Supabase.", ["Figma", "Flutter", "Supabase"], "Académique"],
  ["05", "OBVX", "Boutique e-commerce", "Interface responsive avec catalogue dynamique, panier interactif et expérience d’achat claire.", ["HTML5", "CSS3", "JavaScript"], "Réalisé", "", "https://github.com/YvanOssey/obvx"],
  ...
  ["07", "ClairDroit", "Blog juridique full-stack", "Blog juridique avec espace d’administration sécurisé, publication d’articles par rubrique, personnalisation éditoriale, stockage d’images Cloudflare R2, notifications Resend et déploiement Railway.", ["React", "Node.js", "MySQL", "Railway", "Cloudflare R2", "Resend"], "En ligne", "https://clairdroit-production.up.railway.app/", "https://github.com/YvanOssey/clairdroit"],
  ["08", "Story’s", "Gestion de blanchisserie à domicile", "Application web pour gérer les collectes de linge, suivre les commandes, organiser les créneaux et coordonner l’activité opérationnelle d’une blanchisserie à domicile.", ["React", "TypeScript", "Node.js", "Express", "tRPC", "MySQL", "Drizzle ORM"], "En développement", "", ""],
...
const skillGroups = [
  { title: "Frontend", tone: "cyan", skills: [
    { name: "HTML5", logo: "/manus-storage/html5_86755049.svg", alt: "Logo HTML5" }, { name: "CSS3", logo: "/manus-storage/css3_d8526b9b.svg", alt: "Logo CSS3" }, { name: "JavaScript (ES6+)", logo: "/manus-storage/javascript_8e097637.svg", alt: "Logo JavaScript" }, { name: "React.js", logo: "/manus-storage/react_43dfda05.svg", alt: "Logo React" }, { name: "Flutter", logo: "/manus-storage/flutter_4d553e3e.svg", alt: "Logo Flutter" }, { name: "Dart", logo: "/manus-storage/dart_a7f50049.svg", alt: "Logo Dart" },
  ] },
  { title: "Backend", tone: "violet", skills: [
    { name: "Node.js", logo: "/manus-storage/nodejs_ad65e39c.svg", alt: "Logo Node.js" }, { name: "Express.js", logo: "/manus-storage/express_ecc63bb0.svg", alt: "Logo Express.js" }, { name: "PHP", logo: "/manus-storage/php_14cfc10a.svg", alt: "Logo PHP" }, { name: "Python", logo: "/manus-storage/python_be4c2cdb.svg", alt: "Logo Python" },
  ] },
  { title: "Bases de données", tone: "green", skills: [
    { name: "MySQL", logo: "/manus-storage/mysql_9ad94e2c.svg", alt: "Logo MySQL" }, { name: "SQL", logo: "database", alt: "Pictogramme SQL" }, { name: "Supabase", logo: "/manus-storage/supabase_15183bce.svg", alt: "Logo Supabase" },
  ] },
  { title: "Outils", tone: "yellow", skills: [
    { name: "Git", logo: "/manus-storage/git_9749934c.svg", alt: "Logo Git" }, { name: "GitHub", logo: "/manus-storage/github_b6404b42.svg", alt: "Logo GitHub" }, { name: "Linux", logo: "/manus-storage/linux_47b7c948.svg", alt: "Logo Linux" }, { name: "VMware", logo: "vmware", alt: "Pictogramme VMware" }, { name: "Android Studio", logo: "/manus-storage/androidstudio_fe96c1ab.svg", alt: "Logo Android Studio" }, { name: "Figma", logo: "/manus-storage/figma_babc7577.svg", alt: "Logo Figma" }, { name: "Canva", logo: "/manus-storage/canva_20d9cc6d.svg", alt: "Logo Canva" }, { name: "Pack Office", logo: "office", alt: "Pictogramme Pack Office" }, { name: "Railway", logo: "railway", alt: "Pictogramme Railway" }, { name: "Cloudflare R2", logo: "/manus-storage/cloudflare_9b78c778.svg", alt: "Logo Cloudflare" }, { name: "Resend", logo: "resend", alt: "Pictogramme Resend" },
  ] },
  ...
  return <div className="source-portfolio">
    <nav className="source-nav" aria-label="Navigation principale">
      ...
      <div className={`source-links ${menuOpen ? "open" : ""}`}>
        <a href="#about" onClick={() => setMenuOpen(false)}>À propos</a><a href="#skills" onClick={() => setMenuOpen(false)}>Stacks</a><a href="#projects" onClick={() => setMenuOpen(false)}>Projets</a><a href="#contact" onClick={() => setMenuOpen(false)}>Contact</a>
      </div>
    ...
    <footer className="source-footer"><span>[YVAN.DEV]</span><small>© 2026 — Ossey Yvan Jean De Kenty</small><div><a href="https://github.com/YvanOssey" target="_blank" rel="noreferrer"><Github size={16} /></a><a href="https://linkedin.com/in/yvan-ossey" target="_blank" rel="noreferrer"><Linkedin size={16} /></a></div></footer>
  </div>;
}
